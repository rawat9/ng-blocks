    ...
    <div class="relative py-12 md:py-16 px-4">
      ...
      <section class="text-center mx-auto max-w-3xl mb-16">
        ...
        <div
          ...
          style="view-transition-name: card-tabs"
        >
        ...
        >
          ...
          <span
            class="bg-linear-to-r from-violet-600 via-fuchsia-500 to-pink-500 bg-clip-text text-transparent"
          >
            tabs
          </span>
        </h1>
        ...
        >
          Organize content into switchable panels with accessible tab
          navigation.
        </p>
      </section>
      ...
      <section class="flex flex-col gap-12 w-full">
        <!-- Component Card: Tabs (Coming Soon) -->
        <div
          appAnimateOnScroll
          ...
          >
            <div class="text-center">
              ...
              <p class="text-neutral-500 dark:text-neutral-400">
                Tab components coming soon...
              </p>
            </div>
          </div>

          <p class="mt-3 text-sm text-neutral-500 dark:text-neutral-400">
            Accessible tab components with keyboard navigation and ARIA support.
          </p>
        </div>
      </section>
      ...
      >
        <app-blocks-nav [currentPath]="'/tabs'" />
      </section>
    </div>
  `,
})
