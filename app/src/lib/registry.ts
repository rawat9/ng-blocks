...
import { Workflow1 } from '#/blocks/diagram'
...
export const blocks: Block[] = [
  ...
  {
    title: 'Diagram',
    description: 'Visualize workflows and relationships with diagrams',
    route: '/diagram',
    ...
    components: [
      {
        ...
        path: 'workflow-1.ts',
        component: Workflow1,
        import: `import { Workflow1 } from 'ng-blocks/diagram/workflow-1'`,
        usage: `
      <Workflow1></Workflow1>
    `
      }
